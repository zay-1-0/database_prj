...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="App_Rej_Leaves" runat="server" Text="Process Pending Leaves" OnClick="Proc_Lev" CssClass="btn" />
            <asp:Button ID="Eval_Emp" runat="server" Text="Evaluate Employee" OnClick="Eval_Emp1" CssClass="btn" />
        </div>
    </form>
</body>
</html>
